  ...
  return (
    <div>
      ...
      <main>
        ...
        {/* Hero Section */}
        <header className="relative h-[70vh] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/tews-falls.jpg')" }}>
          ...
          <div className="relative text-center text-white space-y-6 px-6">
            ...
            <Link href="/book" className="inline-block bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl text-lg shadow-lg transition transform hover:-translate-y-1">
              Book Now
            </Link>
          </div>
        </header>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12">
            <div className="lg:w-1/2 flex flex-col items-center text-center lg:text-left border-b lg:border-r lg:border-b-0 border-gray-300 pb-8 lg:pb-0 lg:pr-8">
              ...
              <table className="mt-6 text-left text-sm">
                <tbody>
                <tr>
                  <td className="font-bold text-red-700 pr-2">Address:</td>
                  <td>247 King Street West, Dundas, Ontario</td>
                </tr>
                <tr>
                  <td className="font-bold text-red-700 pr-2">Email:</td>
                  <td>dundasweightlossclinic@gmail.com</td>
                </tr>
                <tr>
                  <td className="font-bold text-red-700 pr-2">Mobile:</td>
                  <td>905-570-2610</td>
                </tr>
                <tr>
                  <td className="font-bold text-red-700 pr-2">Fax:</td>
                  <td>438-600-9815</td>
                </tr>
                </tbody>
              </table>
        ...
        <div className="overflow-hidden">
          <Trees className="w-full translate-y-2" />
        </div>
        ...
        <section id="services" className="py-20 text-center container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8">
            <div className="border-2 border-gray-300 rounded-xl p-6 shadow-md w-80">
              <h3 className="text-3xl font-bold text-red-600">Free</h3>
              <p className="mt-2 font-semibold">Initial 1 hour Consultation</p>
              <ul className="mt-4 space-y-2 text-left">
                <li className="flex items-center space-x-2"><FontAwesomeIcon icon={faCheck} className="text-green-600" /> <span>Meeting held remotely</span></li>
                <li className="flex items-center space-x-2"><FontAwesomeIcon icon={faCheck} className="text-green-600" /> <span>Meeting held in person</span></li>
              </ul>
            </div>
            <div className="border-2 border-gray-300 rounded-xl p-6 shadow-md w-80">
              <h3 className="text-3xl font-bold text-red-600">$40/hr</h3>
              <ul className="mt-4 space-y-2 text-left">
                <li className="flex items-center space-x-2"><FontAwesomeIcon icon={faCheck} className="text-green-600" /> <span>In person and remote appointments</span></li>
                <li className="flex items-center space-x-2"><FontAwesomeIcon icon={faCheck} className="text-green-600" /> <span>No upfront fees</span></li>
                <li className="flex items-center space-x-2"><FontAwesomeIcon icon={faCheck} className="text-green-600" /> <span>Pay as you go</span></li>
              </ul>
            </div>
          </div>
          <p className="mt-8 text-lg">No hidden costs</p>
          <h4 className="text-xl font-bold text-red-600 mt-2">Check your private or group insurance benefits for coverage.</h4>
        </section>
        ...
        <section id="location" className="py-20 bg-gray-100 text-center">
          ...
          <p className="mb-6">Shared space with Myers Chiropractic.</p>
